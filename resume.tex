...
%%% Override a directory ldocation for fonts(default: 'fonts/')
\fontdir[fonts/]
...
%%% Essentials
\name{Loren}{Jiang}
\address{989 45th St., Oakland CA 94608}
\mobile{(949) 769-0678} 
%%% Social
\email{loren.jiang@gmail.com}
\homepage{lorenjiang.com}
\github{loren-jiang}
\linkedin{loren-jiang}
%%% Optionals
% \position{Software Engineer{\enskip\cdotp\enskip} Lab Automation}
% \quote{``"}
...
\import{\sectiondir}{featured.tex}
